  ...
  return (
    <main className="relative text-gray-900">
      ...
      <footer className="relative mt-40 overflow-hidden">
        ...
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0B0B0B] via-[#0B0B0B] to-black" />

        {/* Decorative Glow */}
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-purple-600/20 blur-3xl rounded-full" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-28 text-white">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-gray-400">
              ...
              and create unforgettable memories — all in one place.
            </p>

            <div className="mt-10 flex justify-center gap-4">
              <a
                href="/services"
                className="px-8 py-4 rounded-full bg-white text-black font-medium hover:opacity-90"
              >
                Explore Services
              </a>
              <a
                href="/auth/signup"
                className="px-8 py-4 rounded-full border border-white/30 hover:bg-white hover:text-black transition"
              >
                Sign Up Free
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 text-sm text-gray-400">
            ...
            <div>
              ...
              <p className="leading-relaxed">
                EventMate helps you discover trusted vendors,
                get inspired by real events, and plan celebrations
                with confidence.
              </p>
            </div>
            ...
            {/* DISCOVER */}
            <div>
              <p className="text-white font-medium mb-4">Discover</p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="/become-a-vendor" className="hover:text-white">Become a Vendor</a></li>
              </ul>
            </div>
